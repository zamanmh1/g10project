...
public class AlarmSystem {
	...
	private void spawnGuard() {
		...
		// Initialise a new guard, using the locations in which the player was spotted triggering the alarm.
		...
		// Add the guard to the controller, allowing its state to be updated automatically.
